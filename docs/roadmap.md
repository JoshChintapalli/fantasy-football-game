...
- [x] Player Selection Per Posistion - Give options of best players, given the game initialization and team spin, for each open position on the roster and allow only one selection per spin
